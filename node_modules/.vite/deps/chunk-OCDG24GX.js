...
// node_modules/@web3-onboard/magic/dist/index-491155c1.js
var import_dist = __toESM(require_dist(), 1);
var import_joi = __toESM(require_joi_browser_min(), 1);
var userEmail = import_joi.default.string().email({ tlds: { allow: false } }).allow(null);
var magicOptions = import_joi.default.object({
  apiKey: import_joi.default.string().required(),
  userEmail
});
...
var validateMagicInitOptions = (data) => {
  return validate(magicOptions, data);
};
var validateUserEmail = (email) => {
...
function magic(options) {
  ...
  const { apiKey, userEmail: userEmail2 } = options;
  const walletName = "Magic Wallet";
  return () => {
    return {
      label: walletName,
      getIcon: async () => (await import("./icon-87babf0a-OWBQF3SB.js")).default,
      getInterface: async ({ EventEmitter, BigNumber, chains }) => {
        const { Magic, RPCErrorCode } = await import("./es-IEPQQHGC.js");
        const loginModal = (await import("./login-modal-c661232c-VWROKQL7.js")).default;
        const brandingHTML = (await import("./branding-111ba967-YZ2TXEJM.js")).default;
        const { createEIP1193Provider, ProviderRpcErrorCode, ProviderRpcError } = await import("./dist-VOXQ6GJD.js");
        ...
        function patchProvider() {
          const patchedProvider = createEIP1193Provider(magicProvider, {
            eth_requestAccounts: async ({ baseRequest }) => {
              try {
                if (userEmail2)
                  loggedIn = await loginWithEmail(userEmail2);
                if (!loggedIn)
                  await handleLogin();
...
//# sourceMappingURL=chunk-OCDG24GX.js.map
