  ...
  return () => {
    return {
      ...
      getInterface: async ({ chains, EventEmitter }) => {
        const { StaticJsonRpcProvider } = await import("./lib-OTAHX2WD.js");
        const { ProviderRpcError, ProviderRpcErrorCode } = await import("./dist-VOXQ6GJD.js");
        const { default: WalletConnect } = await import("./esm-HX2LE76U.js");
        let QRCodeModal = await import("./cjs-SCUPA4XE.js");
  ...
  return () => {
    return {
      ...
      getInterface: async ({ chains, EventEmitter, appMetadata }) => {
        const { ProviderRpcError, ProviderRpcErrorCode } = await import("./dist-VOXQ6GJD.js");
        const { default: EthereumProvider } = await import("./index.es-HRGAYBWL.js");
        const { Subject, fromEvent } = await import("./esm5-L4ZNQYO5.js");
        const { takeUntil, take } = await import("./operators-BIYKMZNO.js");
        const getMetaData = () => {
          if (!appMetadata)
