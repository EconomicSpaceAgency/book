...
function coinbaseWallet({ darkMode = false } = {}) {
  return () => {
    return {
      ...
      getIcon: async () => (await import("./icon-HOX4FPSK.js")).default,
      getInterface: async ({ chains, appMetadata }) => {
        const [chain] = chains;
        const { name, icon } = appMetadata || {};
        const { default: CoinbaseWalletSDK } = await import("./dist-IGRX2AC5.js");
